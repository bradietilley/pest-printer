...
namespace BradieTilley\Cloned\NunoMaduro\Collision\Adapters\Phpunit;
...
/**
 * Cloned from Nuno's Printer, without the final flag on the class.
 * 
 * @package NunoMaduro\Collision\Adapters\Phpunit\Printer
 */
